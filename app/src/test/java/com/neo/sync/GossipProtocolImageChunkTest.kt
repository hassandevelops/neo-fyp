...
class GossipProtocolImageChunkTest {
    ...
    fun setup() {
        ...
        gossipProtocol = GossipProtocol(
            ...
            notificationRepository = mockk<com.neo.data.repository.NotificationRepository>(relaxed = true),
            peerProfileRepository = mockk(relaxed = true),
            followRepository = mockk(relaxed = true),
            userPreferences = mockk(relaxed = true),
            avatarStore = mockk(relaxed = true),
            identityManager = mockk<com.neo.security.IdentityManager>(relaxed = true),
